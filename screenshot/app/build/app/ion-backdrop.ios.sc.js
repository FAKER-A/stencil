...
class Backdrop {
    ...
    static get style() { return "\n.sc-ion-backdrop-ios-h {\n  left: 0;\n  right: 0;\n  top: 0;\n  bottom: 0;\n  display: block;\n  position: absolute;\n  -webkit-transform: translateZ(0);\n  transform: translateZ(0);\n  contain: strict;\n  cursor: pointer;\n  opacity: .01;\n  -ms-touch-action: none;\n  touch-action: none;\n  z-index: 2; }\n  .backdrop-hide.sc-ion-backdrop-ios-h {\n    background: transparent; }\n  .backdrop-no-tappable.sc-ion-backdrop-ios-h {\n    cursor: auto; }\n\nbody.backdrop-no-scroll.sc-ion-backdrop-ios {\n  overflow: hidden; }\n\n.sc-ion-backdrop-ios-h {\n  background-color: var(--ion-backdrop-color, #000); }\n"; }
...
class Radio {
    ...
    static get style() { return "\n.sc-ion-radio-ios-h {\n  --ion-color-base: var(--ion-color-primary, #3880ff);\n  display: inline-block;\n  position: relative;\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box;\n  -webkit-user-select: none;\n  -moz-user-select: none;\n  -ms-user-select: none;\n  user-select: none; }\n\n.radio-disabled.sc-ion-radio-ios-h {\n  pointer-events: none; }\n\n.radio-icon.sc-ion-radio-ios {\n  display: block;\n  position: relative;\n  width: var(--width);\n  height: var(--height);\n  contain: layout size style; }\n\ninput.sc-ion-radio-ios {\n  left: 0;\n  top: 0;\n  margin: 0;\n  position: absolute;\n  width: 100%;\n  height: 100%;\n  border: 0;\n  background: transparent;\n  cursor: pointer;\n  -webkit-appearance: none;\n  -moz-appearance: none;\n  appearance: none;\n  outline: none; }\n\n.radio-icon.sc-ion-radio-ios, .radio-inner.sc-ion-radio-ios {\n  -webkit-box-sizing: border-box;\n  box-sizing: border-box; }\n\n.sc-ion-radio-ios-h {\n  --width: 16px;\n  --height: 21px; }\n\n.item-radio.item-ios.sc-ion-radio-ios   ion-label.sc-ion-radio-ios {\n  margin-left: 0; }\n\n.radio-checked.sc-ion-radio-ios-h   .radio-inner.sc-ion-radio-ios {\n  left: 7px;\n  top: 4px;\n  position: absolute;\n  width: 5px;\n  height: 12px;\n  -webkit-transform: rotate(45deg);\n  transform: rotate(45deg);\n  border-width: 2px;\n  border-top-width: 0;\n  border-left-width: 0;\n  border-style: solid;\n  border-color: var(--ion-color-base); }\n\n.radio-disabled.sc-ion-radio-ios-h {\n  opacity: 0.3; }\n\n.radio-key.sc-ion-radio-ios-h   .radio-icon.sc-ion-radio-ios::after {\n  border-radius: 50%;\n  left: -9px;\n  top: -8px;\n  display: block;\n  position: absolute;\n  width: 36px;\n  height: 36px;\n  background: var(--ion-color-primary-tint, #4c8dff);\n  content: \"\";\n  opacity: .2; }\n\n.in-item.sc-ion-radio-ios-h {\n  margin: 8px 11px 8px 8px;\n  display: block;\n  position: static; }\n\n.in-item[slot=\"start\"].sc-ion-radio-ios-h {\n  margin: 8px 21px 8px 3px; }\n"; }
    static get styleMode() { return "ios"; }
}
