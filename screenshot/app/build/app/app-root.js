...
import { a as debounce } from './chunk-9cb229af.js';

class AppRoot {
    render() {
        return (h("ion-app", null,
            h("ion-router", { useHash: false },
                h("ion-route", { url: "/", component: "snapshot-list" }),
                h("ion-route", { url: "/:snapshotId/", component: "snapshot-detail" }),
                h("ion-route", { url: "/:a/:b/", component: "snapshot-compare" })),
            h("ion-nav", null)));
    }
...
export { AppRoot, App as IonApp, Route as IonRoute, Router as IonRouter };
